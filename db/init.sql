...
CREATE TABLE IF NOT EXISTS invitations (
  ...
  guest_group TEXT CHECK (guest_group IN ('kerabat_teman', 'keluarga', 'kantor', 'lainnya')),
  max_guests SMALLINT CHECK (max_guests IS NULL OR max_guests BETWEEN 1 AND 10),
  max_devices SMALLINT CHECK (max_devices IS NULL OR max_devices BETWEEN 1 AND 100),
